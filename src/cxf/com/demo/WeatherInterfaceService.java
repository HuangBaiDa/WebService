 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", targetNamespace = "http://sei.cxf/", wsdlLocation = "http://127.0.0.1:12345/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACESERVICE_QNAME = new QName("http://sei.cxf/", "WeatherInterfaceService");
    ...
    public WeatherInterface getWeatherInterfacePort() {
        return super.getPort(new QName("http://sei.cxf/", "WeatherInterfacePort"), WeatherInterface.class);
    }
    ...
    public WeatherInterface getWeatherInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sei.cxf/", "WeatherInterfacePort"), WeatherInterface.class, features);
    }
