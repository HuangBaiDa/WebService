...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherByCity_QNAME = new QName("http://selimpl.webservice/", "getWeatherByCity");
    private final static QName _GetWeatherByCityResponse_QNAME = new QName("http://selimpl.webservice/", "getWeatherByCityResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://selimpl.webservice/", name = "getWeatherByCity")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://selimpl.webservice/", name = "getWeatherByCityResponse")
